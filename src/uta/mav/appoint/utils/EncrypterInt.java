...
public class EncrypterInt {
  public static void main(String[] args) {
	 EncrypterInt enc = new EncrypterInt();
	 int encrypted = enc.encipher(1001297389);
	 System.out.println(encrypted);
	 System.out.println(enc.decipher(encrypted));
  }
	//////////////////
	// Private Data //
	//////////////////
	...
	// Constructors //
	//////////////////
public EncrypterInt() { this(DEFAULT_KEY); }

public EncrypterInt(int key) { setKey(key); }
